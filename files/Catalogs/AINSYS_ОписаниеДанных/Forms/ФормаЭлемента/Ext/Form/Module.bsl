...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//ЖурналСобытий.КомпоновщикНастроек.Настройки.Отбор.Элементы["ПравилоОбмена"]
КонецПроцедуры
...
Процедура ОпределитьВидимость()
	...
	//	ЭтаФорма.Элементы.ГруппаРучноеОписание.Видимость = Ложь;
		ЭтаФорма.Элементы.ГруппаСКД.Видимость = Истина;
	Иначе
	//	ЭтаФорма.Элементы.ГруппаРучноеОписание.Видимость = Истина;
...
Процедура ПриОткрытии(Отказ)
	...
	ЭтаФорма.Элементы.ТекстПодсказкиВыгрузки.Заголовок = "Доступны переменные:
					...
					|ВыборкаВыгрузки - при использовании схемы компоновки данных (СКД) будет иметь тип ДеревоЗначений.
					|					Этот объект можно изменить. Если СКД не используется, то необходимо определить переменную ВыборкаВыгрузки.
...
Функция ПосмотретьВыгружаемыеДанныеНаСервере(Ссылка)
	...
	//тд = Справочники.AINSYS_ОписаниеДанных.ПосмотретьВыгружаемыеДанные(Ссылка);
